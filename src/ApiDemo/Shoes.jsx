...
const Shoes = () => {
  const [arrProduct,setArrProductApi]= useState([])
...
const getAllProductAxios = async ()=>{
  ...
  setArrProductApi(res.data.content);
  
}

  // useEffect(()=>{
  //   //hàm này sẽ chạy khi html render và mỗi khi bất kì hàm setState nào đucợ gọi
  //   // console.log('useEffect')
  //   getAllProductApi();
  // })

  useEffect(()=>{
    //dependecy List: [] thì hàm này chỉ chạy 1 lần sau khi component render
    // getAllProductApi();
    getAllProductAxios();
  },[])
