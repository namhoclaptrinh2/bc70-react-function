//TRANG NÀY VỪA LÀ TRANG ADD VỪA LÀ TRANG EDIT
...
console.log(match); //nếu null là add product, ngược lại có giá trị là edit
const isEdit = !!match; // true: edit hoặc false : addnew
const prodForm = useFormik({
    ...
    validationSchema:yup.object().shape({
            id: yup.string().required('id cannot be blank !').matches()
