...
const EditProduct = () => {
  ...
  const prodEditForm= useFormik({
    ...
    onSubmit:async (value) =>{
          ...
          //Sau khi chinmhr sửa xong thì dùng navigate chuyển về trang quản lý
  ...
  const getProductById = async () => {
    ...
    console.log(res.data);// Lấy dữ liệu về thành công => Sau đó cần đưa lên form
    // prodEditForm.setFieldValue('name', res.data.name) // đây là dùng cho set value tùy ý 
